...
im = ax.imshow(acc)
im2 = ax2.imshow(val_acc)

im3 = ax3.imshow(top5)
im4 = ax4.imshow(val_top5)

im5 = ax5.imshow(logloss)
im6 = ax6.imshow(val_logloss)
...
fig5.tight_layout()
fig6.tight_layout()
# fig.savefig('DistilledSqueezenetTrainingAcc.jpg')
# fig2.savefig('DistilledSqueezenetValAcc.jpg')
# fig3.savefig('DistilledSqueezenetTrainingTop5Acc.jpg')
# fig4.savefig('DistilledSqueezenetValTop5Acc.jpg')
# fig5.savefig('DistilledSqueezenetTrainingLogloss.jpg')
# fig6.savefig('DistilledSqueezenetValLogLoss.jpg')
